...
function useAddMutation(key: string, url: string , params?:any): UseMutationResult<AxiosResponse, unknown, any, unknown> {
  ...
  return useMutation<AxiosResponse, unknown, any, unknown>(
    ...
    {
      onSuccess: (data) => {
        queryClient.invalidateQueries([params ? params : key]);
